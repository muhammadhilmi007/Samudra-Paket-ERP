  ...
  const footerLinks = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Tracking', href: '/services/tracking' },
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8 xl:col-span-1">
            ...
            <Typography variant="body2" className="text-gray-500 max-w-xs">
              PT. Sarana Mudah Raya is a leading logistics and shipping company in Indonesia, providing reliable delivery services nationwide.
            </Typography>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <Typography variant="body2" className="text-gray-400 text-center">
            &copy; {currentYear} PT. Sarana Mudah Raya. All rights reserved.
          </Typography>
        </div>
      </div>
    </footer>
